...
This mechanism has been integrated into Bitcore-Node-Menelik which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/raptor3um/insight-api-menelik#web-socket-api](https://github.com/raptor3um/insight-api-menelik#web-socket-api)
* API: [https://github.com/raptor3um/insight-api-menelik#instantsend-transactions](https://github.com/raptor3um/insight-api-menelik#instantsend-transactions)

...
* menelik.conf: contains configuration settings for menelikd or menelik-qt
* menelikd.pid: stores the process id of menelikd while running
* database/*: BDB database environment; only used for wallet
* db.log: wallet database log file
* debug.log: contains debug information and general logging generated by menelikd or menelik-qt

...
This document provides guidelines for internationalization of the Menelik Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `menelik_en.ts` remains unchanged.

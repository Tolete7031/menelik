...
# TestP2PConn: A peer we use to send messages to menelikd, and store responses.
...
class CompactBlocksTest(BitcoinTestFramework):
    ...
    # This test actually causes menelikd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that menelikd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for menelikd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # menelikd will not send blocktxn responses for blocks whose height is

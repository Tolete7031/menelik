...
class LLMQCoinbaseCommitmentsTest(MenelikTestFramework):
    def set_test_params(self):
        self.set_menelik_test_params(4, 3, fast_dip3_enforcement=True)
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as MenelikTestFramework doesn't support this atm)

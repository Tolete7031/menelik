...
"""Verify that starting menelikd with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start menelikd with -h for help text")
        ...
        self.log.info("Start menelikd with -version for version information")

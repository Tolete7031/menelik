...
from test_framework.test_framework import MenelikTestFramework
...
class LLMQChainLocksTest(MenelikTestFramework):
    def set_test_params(self):
        self.set_menelik_test_params(6, 5, fast_dip3_enforcement=True)

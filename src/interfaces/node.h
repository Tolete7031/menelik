...
//! Interface for the src/evo part of a menelik node (menelikd process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/llmq part of a menelik node (menelikd process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a menelik node (menelikd process).
namespace Smartnode
{
class Sync
{
...
//! Top-level interface for a menelik node (menelikd process).
class Node
{
public:
    virtual ~Node() {}

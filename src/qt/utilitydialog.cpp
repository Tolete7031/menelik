    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = "Usage:\n"
            "  menelik-qt [command-line options]                     \n";
...
All the Menelik in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.001 MENEL, 0.01 MENEL, 0.1 MENEL, 1 MENEL and 10 MENEL -- sort of like the paper money you use every day.</li> \

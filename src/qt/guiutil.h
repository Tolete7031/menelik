...
/** Utility functions used by the Menelik Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "menelik:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load menelik specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a menelik specific theme is activated (light/dark).*/

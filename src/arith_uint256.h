...
#ifndef MENELIK_ARITH_UINT256_H
#define MENELIK_ARITH_UINT256_H
...
public:
     ...
     *
     * Menelik only uses this "compact" format for encoding difficulty

...
rm -f src/config/menelik-config.h
...
rm -rf test_bitcoin.coverage/ menelik-gtest.coverage/ total.coverage/
...
clean_exe src/menelik-cli
clean_exe src/menelikd
clean_exe src/menelik-gtest
clean_exe src/menelik-tx
clean_exe src/test/test_menelik
clean_exe src/test/test_menelik_fuzzy
...
clean_dep . src/config/menelik-config.h.in

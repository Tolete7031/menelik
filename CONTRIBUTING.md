Contributing to Menelik Core
============================

The Menelik Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/Raptor3um/menelik/blob/master/doc/translation_process.md) 
...
The following applies to code changes to the Menelik Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Menelik
Network Protocol consensus changes.

Whether a pull request is merged into Menelik Core rests with the project merge
...
Patches that change Menelik consensus rules are considerably more involved than
...
Where a patch set proposes to change the Menelik consensus, it must have been
...
The review process is normally fairly responsive on the Menelik Core repository, however
...
The project leader is the release manager for each Menelik Core release.
